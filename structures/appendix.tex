\begin{appendices}
\chapter{Detailed Algorithm Definitions}
\label{app:algorithms}
\setcounter{algorithm}{0}
\renewcommand{\thealgorithm}{\thechapter.\arabic{algorithm}}

This appendix reproduces the full pseudocode for the implementation-level and
standard procedures referenced in Chapters~4--6. Each procedure is summarised in
prose at its point of use in the main text; the complete step-by-step listings
are collected here for reproducibility, so that the methodological narrative of
the main chapters is not interrupted by full-page code blocks.
