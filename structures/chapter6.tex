...
\end{tabularx}
\footnotesize
\textit{Note: SQA skipped for $N > 10$ due to timeout. Gap $= (\mathrm{Cost}_{\mathrm{method}} - \mathrm{Cost}_{\mathrm{MILP}})/\mathrm{Cost}_{\mathrm{MILP}} \times 100\%$. Dashes indicate method not executed at that scale.}
