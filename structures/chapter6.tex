...
\begin{figure}[!htbp]
    ...
    \caption{Decoded $N=7$ maintenance schedules (MILP,
    QAOA-XY on \texttt{ibm\_fez}, QIEA, GA). Red dashed line:
    $24$-h risk horizon; bar colour encodes priority level; bars
    to the right of the line are (C3) violations. QAOA-XY incurs
    $V=2$ versus $V=8$ for the best classical heuristic.}
